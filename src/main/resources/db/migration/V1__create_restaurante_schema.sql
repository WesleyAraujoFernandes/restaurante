...
CREATE INDEX idx_pedidos_items_pedido ON pedidos_itens(pedido_id);
CREATE INDEX idx_pedidos_items_produto ON pedidos_itens(produto_id);
CREATE INDEX idx_pedidos_items_status ON pedidos_itens(status);
