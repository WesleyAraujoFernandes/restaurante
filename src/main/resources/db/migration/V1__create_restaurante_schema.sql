...
CREATE INDEX idx_pedido_items_produto ON pedido_items(produto_id);
CREATE INDEX idx_pedido_items_status ON pedido_items(status);
...
CREATE TABLE pagamentos (
    ...
    status VARCHAR(30) NOT NULL DEFAULT 'PENDENTE',
    codigo_transicao_externa VARCHAR(100),
